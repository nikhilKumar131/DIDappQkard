...
import { activateOrDeactivateDID, getDID, getDocFromId, getDocFromOwner, getDocFromPublisher, getProviderOrSigner, registerDID, registerDIDdoc, updateDID, updateDoc } from "../components/metamaskFunctions"
    ...
    <div>
      ...
      <div className="flex flex-wrap">
        <div className="w-full md:w-1/2 bg-gray-100 p-4">
          <h1 className="text-4xl font-bold mb-4">DID functions</h1>
          <p className="text-lg">Use all the functions related to DIDs here.</p>
          ...
          <div className='space-y-3'>
            ...
            <button className='rounded-lg bg-slate-400 hover:bg-slate-300' onClick={() => getDID(web3modalRef, inputs.DidGetowner)}><a className='mx-4 my-2'>Submit</a></button>
